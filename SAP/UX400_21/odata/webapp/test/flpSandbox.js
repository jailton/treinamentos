		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "oData App",
									"targetURL": "#student00saptrainingodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingodata-display": {
								"semanticObject": "student00saptrainingodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.odata",
									"url": sap.ui.require.toUrl("student00/sap/training/odata")
								}
							}
						}
					}
