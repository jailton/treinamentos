		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#student00saptrainingpropertybinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingpropertybinding-display": {
								"semanticObject": "student00saptrainingpropertybinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.propertybinding",
									"url": sap.ui.require.toUrl("student00/sap/training/propertybinding")
								}
							}
						}
					}
