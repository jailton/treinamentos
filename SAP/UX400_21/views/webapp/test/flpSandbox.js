		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Views",
									"targetURL": "#student00saptrainingviews-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingviews-display": {
								"semanticObject": "student00saptrainingviews",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.views",
									"url": sap.ui.require.toUrl("student00/sap/training/views")
								}
							}
						}
					}
