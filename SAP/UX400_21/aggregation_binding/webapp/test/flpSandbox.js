		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#student00saptrainingaggregationbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingaggregationbinding-display": {
								"semanticObject": "student00saptrainingaggregationbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.aggregationbinding",
									"url": sap.ui.require.toUrl("student00/sap/training/aggregationbinding")
								}
							}
						}
					}
