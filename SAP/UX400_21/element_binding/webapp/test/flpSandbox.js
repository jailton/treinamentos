		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#student00saptrainingelementbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingelementbinding-display": {
								"semanticObject": "student00saptrainingelementbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.elementbinding",
									"url": sap.ui.require.toUrl("student00/sap/training/elementbinding")
								}
							}
						}
					}
