		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formatter App",
									"targetURL": "#student00saptrainingformatter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingformatter-display": {
								"semanticObject": "student00saptrainingformatter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.formatter",
									"url": sap.ui.require.toUrl("student00/sap/training/formatter")
								}
							}
						}
					}
