		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student00saptrainingmodularization-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingmodularization-display": {
								"semanticObject": "student00saptrainingmodularization",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.modularization",
									"url": sap.ui.require.toUrl("student00/sap/training/modularization")
								}
							}
						}
					}
