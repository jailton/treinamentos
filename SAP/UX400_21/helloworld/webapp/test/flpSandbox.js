		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello, World",
									"targetURL": "#student00saptraininghelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptraininghelloworld-display": {
								"semanticObject": "student00saptraininghelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.helloworld",
									"url": sap.ui.require.toUrl("student00/sap/training/helloworld")
								}
							}
						}
					}
