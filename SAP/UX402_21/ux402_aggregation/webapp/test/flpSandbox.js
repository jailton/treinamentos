		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student00saptrainingux402aggregation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingux402aggregation-display": {
								"semanticObject": "student00saptrainingux402aggregation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.ux402aggregation",
									"url": sap.ui.require.toUrl("student00/sap/training/ux402aggregation")
								}
							}
						}
					}
