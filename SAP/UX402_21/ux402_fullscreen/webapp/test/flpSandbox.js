		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student00saptrainingux402fullscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingux402fullscreen-display": {
								"semanticObject": "student00saptrainingux402fullscreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.ux402fullscreen",
									"url": sap.ui.require.toUrl("student00/sap/training/ux402fullscreen")
								}
							}
						}
					}
