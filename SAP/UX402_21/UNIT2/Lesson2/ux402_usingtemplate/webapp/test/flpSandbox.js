		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#student00saptrainingux402usingtemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingux402usingtemplate-display": {
								"semanticObject": "student00saptrainingux402usingtemplate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.ux402usingtemplate",
									"url": sap.ui.require.toUrl("student00/sap/training/ux402usingtemplate")
								}
							}
						}
					}
