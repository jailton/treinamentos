sap.ui.define([
	"sap/ui/test/Opa5",
	"student00/sap/training/ux402usingtemplate/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("student00.sap.training.ux402usingtemplate.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "student00.sap.training.ux402usingtemplate",
					async: true
				},
				hash: oOptions.hash,
