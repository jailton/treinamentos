		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX402 Demostration",
									"targetURL": "#student00saptrainingux402demo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00saptrainingux402demo-display": {
								"semanticObject": "student00saptrainingux402demo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.ux402demo",
									"url": sap.ui.require.toUrl("student00/sap/training/ux402demo")
								}
							}
						}
					}
